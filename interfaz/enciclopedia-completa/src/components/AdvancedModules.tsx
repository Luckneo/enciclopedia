...
import { stages, dossierSections } from "@/data/creature";
...
export const BiologicalMatrix = memo(function BiologicalMatrix({ accent, plate }: { accent: string; plate: string }) {
  ...
  return (
    <div className="glass-premium rounded-md p-5">
      <ModuleHeader icon={Microscope} title="Matriz Geográfica" code="A · ANATOMÍA" sub="Escaneo orbital · 3 capas planetarias" />
...
/* ════════════════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════════════════ */
const behaviorNodes = [
  { id: "root", x: 50, y: 12, label: "Origen", v: 100 },
...
/* ════════════════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════════════════ */
const loreEvents = [
  { era: "Era −∞", title: "Descubrimiento del Mundo", civ: "Cosmos Primordial" },
  { era: "Era I", title: "Primer Contacto", civ: "Estrellas Aciliae" },
  { era: "Era III", title: "Pacto del Concilio", civ: "Federación Galáctica" },
  { era: "Era VII", title: "Mapeo del Núcleo", civ: "Imperio Estelar" },
  { era: "Era IX", title: "Cartografía Yangzhou", civ: "Humanidad" },
  { era: "Era X", title: "Expedición Actual", civ: "Sistema Solar" },
];
...
export const LoreCodex = memo(function LoreCodex({ accent }: { accent: string }) {
  ...
  return (
    <div className="glass-premium rounded-md p-5">
      <ModuleHeader icon={ScrollText} title="Códice Histórico" code="D · LORE" sub="Cronología · Expediciones · Bitácoras" />
      {/* Timeline */}
      ...
      <div className="tech text-[9px] text-foreground/45 tracking-[0.25em] mt-1 text-center">
        REGISTRO · {loreEvents[active].era} · 22.4 kHz
      </div>
    </div>
  );
});
...
export const GeneticForge = memo(function GeneticForge({ accent }: { accent: string }) {
  ...
  const tree = [
    { gen: "G-0", name: "Planeta Aelyn-VII", pos: { x: 50, y: 10 } },
    { gen: "G-I", name: "Hemisferio Norte", pos: { x: 22, y: 40 } },
    { gen: "G-I", name: "Hemisferio Sur", pos: { x: 50, y: 40 } },
    { gen: "G-I", name: "Anillo Polar", pos: { x: 78, y: 40 } },
    { gen: "G-II", name: "Continente Karnesh", pos: { x: 36, y: 72 } },
    { gen: "G-II", name: "Continente Antar", pos: { x: 64, y: 72 } },
  ];

  return (
    <div className="glass-premium rounded-md p-5">
      <ModuleHeader icon={GitBranch} title="Forja Cartográfica" code="E · EVOLUCIÓN" sub="Árbol Territorial · Subdivisiones" />
      ...
      <SliderRow icon={GitBranch} label="Deriva Territorial" value={drift} min={0} max={100} unit="%" onChange={setDrift} accent={accent} />
