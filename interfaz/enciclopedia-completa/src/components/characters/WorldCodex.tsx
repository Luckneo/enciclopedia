...
import { dossierSections, scaleRefs, timeline } from "@/data/characters-data";
...
const zones = [
  { z: 1, label: "Núcleo de Identidad", tag: "CORE · IDENTITY", color: "oklch(0.78 0.13 80)" },
  { z: 2, label: "Matriz Biológica",    tag: "BIO · ECOLOGY",   color: "oklch(0.7 0.16 145)" },
      ...
      <div className="flex items-end justify-between px-6 md:px-8 pt-6 pb-4">
        <div>
          ...
          <p className="text-foreground/55 text-[12px] mt-2 max-w-[640px] leading-relaxed">
            Matriz de comando del Soberano. Cada punto está vinculado al resto: al
