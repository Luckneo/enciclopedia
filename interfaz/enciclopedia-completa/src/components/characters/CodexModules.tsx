...
const SCALE_DATA: ScaleEntry[] = [
  ...
  { id: "beast", label: "Bestia Adulta", cn: "金角巨兽", meters: 800, displayValue: "800", displayUnit: "m", silhouette: "beast" },
  { id: "stellar", label: "Forma Estelar VII", cn: "恒星级七阶", meters: 1400, displayValue: "1,400", displayUnit: "m", silhouette: "stellar" },
  { id: "world", label: "Mundo Interior", cn: "体内世界", meters: 99_999_000, displayValue: "99,999", displayUnit: "km", silhouette: "world" },
];
...
const TIMELINE: TimelineNode[] = [
  { id: "t0", era: "Primigenia", date: "Era −∞",   title: "Génesis del Huevo",          coords: "RA 00:00 · DEC −∞", threat: "α", detail: "Surgimiento del huevo cósmico en el alba del universo." },
  { id: "t1", era: "Primigenia", date: "Era I",    title: "Primer Devorado",            coords: "RA 04:21 · DEC −47°", threat: "β", detail: "Eclosión. Primera consciencia devoradora despierta." },
  { id: "t2", era: "Federal",    date: "Era III",  title: "Caída de la 3ª Federación", coords: "RA 09:55 · DEC +12°", threat: "Ω", detail: "Aniquilación de la Tercera Federación Galáctica." },
  { id: "t3", era: "Estelar",    date: "Era VII",  title: "Mutación Estelar VII",       coords: "RA 14:02 · DEC −33°", threat: "Ω", detail: "Asciende a Estelar Rango VII por absorción masiva." },
  { id: "t4", era: "Estelar",    date: "Era IX",   title: "Hibernación Yangzhou",       coords: "RA 18:48 · DEC +05°", threat: "Δ", detail: "Hibernación bajo el sector Yangzhou." },
  { id: "t5", era: "Moderna",    date: "Era X",    title: "Despertar Final",            coords: "RA 22:17 · DEC +01°", threat: "Ω", detail: "Despertar y migración hacia el sistema solar interior." },
];
...
const TERMINAL_LINES = [
  ...
  "> descargando dossier #金角巨兽 …",
  "> CLASE   : Bestia del Vacío Estelar · Linaje Primigenio",
  "> RANGO   : Estelar VII · sin techo confirmado",
      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-12 md:col-span-5 final-card">
          ...
          <dl className="mt-5 space-y-2.5 text-[12px]">
            <FinalRow k="Nombre" v="Bestia del Cuerno Dorado · 金角巨兽" />
            <FinalRow k="Clasificación" v="Bestia del Vacío Estelar · Primigenio" />
            <FinalRow k="Rango" v="Estelar VII" />
